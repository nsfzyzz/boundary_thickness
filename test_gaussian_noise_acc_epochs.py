...
exp_ind_list = [3, 6, 8, 11, 12, 19, 26]
robust_acc_result = []
...
for exp_ind in exp_ind_list:
    ...
    for epoch_num in epoch_list:
        ...
        robust_acc = test_gaussian(model, test_loader, noise_sd=args.noise_sd)
...
import pickle
f = open("guassin_n{}_robust_acc_during_training.pkl".format(args.noise_sd),"wb")
